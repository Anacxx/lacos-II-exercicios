// Uma pessoa analista quer conseguir ver 
//quantos gols cada um de seus 5 atacantes marcou
 //nas últimas 5 temporadas, e quer que você construa um código
 // que mostre isso.
...
for (let indice = 0; indice < array.length;indice++){
    console.log(`Jogador ${indice+1}: ${array[indice]}`)
}